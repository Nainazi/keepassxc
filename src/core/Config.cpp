...
static const QHash<Config::ConfigKey, ConfigDirective> configStrings = {
    ...
    {Config::AutoTypeDelay,{QS("AutoTypeDelay"), Roaming, 50}},
    {Config::AutoTypeStartDelay,{QS("AutoTypeStartDelay"), Roaming, 800}},
    ...
    {Config::GlobalAutoTypeKey,{QS("GlobalAutoTypeKey"), Roaming, int(Qt::Key_A)}},
    {Config::GlobalAutoTypeModifiers,
     {QS("GlobalAutoTypeModifiers"), Roaming, int(Qt::ControlModifier | Qt::ShiftModifier)}},
    ...
    {Config::GUI_ApplicationTheme, {QS("GUI/ApplicationTheme"), Roaming, QS("nainazi")}},
    ...
    {Config::PasswordGenerator_Length, {QS("PasswordGenerator/Length"), Roaming, 24}},
