...
void DatabaseSettingsWidgetBrowser::removeSharedEncryptionKeys()
{
    ...
    if (keysToRemove.isEmpty()) {
        MessageBox::information(
            this, tr("No keys found"), tr("No shared encryption keys found in 奈娜子密码本 settings."), MessageBox::Ok);
        return;
    }
    ...
    MessageBox::information(this,
                            ...
                            tr("Successfully removed %n encryption key(s) from 奈娜子密码本 settings.", "", count),
                            MessageBox::Ok);
}
