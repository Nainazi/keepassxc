...
:docdate: 2020-08-31
:doctype: manpage
:mansource: 奈娜子密码本 {revnumber}
:manmanual: General Commands Manual

== NAME
nainazi-passbook - 奈娜子密码本, a personal fork of KeePassXC

== SYNOPSIS
*nainazi-passbook* [_options_] [_filename(s)_]

== DESCRIPTION
*奈娜子密码本* (*nainazi-passbook*) is a personal fork of KeePassXC, a free/open-source password manager or safe which helps you to manage your passwords securely.
...
*--minimized*::
  Starts 奈娜子密码本 minimized to the system tray.
